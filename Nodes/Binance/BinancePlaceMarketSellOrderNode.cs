...
{
    [NodeDefinition("BinancePlaceMarketSellOrderNode", "Place Market Sell Order", NodeTypeEnum.Function, "Binance")]
    [NodeGraphDescription("Allows you to place a market sell order on binance. example result : true for success order and false for fail")]
    public class BinancePlaceMarketSellOrderNode : Node
    {
        public BinancePlaceMarketSellOrderNode(string id, BlockGraph graph)
              : base(id, graph, typeof(BinancePlaceMarketSellOrderNode).Name)
        {
