...
{
    [NodeDefinition("BinancePlaceLimitSellOrderNode", "Place Limit Sell Order", NodeTypeEnum.Function, "Binance")]
    [NodeGraphDescription("Allows you to place a limit Sell order on binance. example result : true for success order and false for fail")]
    public class BinancePlaceLimitSellOrderNode : Node
    {
        public BinancePlaceLimitSellOrderNode(string id, BlockGraph graph)
              : base(id, graph, typeof(BinancePlaceLimitSellOrderNode).Name)
        {
        ...
        public override bool OnExecution()
        {
            try
            {
                ...
                var order = binanceConnector.Client.Spot.Order.PlaceOrder(this.InParameters["symbol"].GetValue().ToString(), global::Binance.Net.Enums.OrderSide.Sell, global::Binance.Net.Enums.OrderType.Limit, quantity: quantity,timeInForce:TimeInForce.GoodTillCancel,price: price_r);
