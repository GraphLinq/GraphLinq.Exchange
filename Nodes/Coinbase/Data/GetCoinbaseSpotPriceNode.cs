...
{
    [NodeDefinition("GetCoinbaseSpotPriceNode", "Get Coinbase Spot Price", NodeTypeEnum.Function, "Coinbase")]
    [NodeGraphDescription("Get the current spot price on Coinbase")]
    public class GetCoinbaseSpotPriceNode : Node
    {
        public GetCoinbaseSpotPriceNode(string id, BlockGraph graph)
              : base(id, graph, typeof(GetCoinbaseSpotPriceNode).Name)
        {
        ...
        public override bool OnExecution()
        {
            ...
            var request = coinbaseConnector.Client.Data.GetSpotPriceAsync(this.InParameters["currencyPair"].GetValue().ToString());
            request.Wait();
