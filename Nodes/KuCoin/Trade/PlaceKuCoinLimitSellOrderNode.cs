...
{
    [NodeDefinition("PlaceKuCoinLimitSellOrderNode", "Place KuCoin Limit Sell Order", NodeTypeEnum.Function, "KuCoin")]
    [NodeGraphDescription("Place KuCoin Limit Sell Order")]
    public class PlaceKuCoinLimitSellOrderNode : Node
    {
        public PlaceKuCoinLimitSellOrderNode(string id, BlockGraph graph)
            : base(id, graph, typeof(PlaceKuCoinLimitSellOrderNode).Name)
        {
        ...
        public override bool OnExecution()
        {
            ...
            var result = connector.Client.PlaceOrderAsync(symbol, Kucoin.Net.Objects.KucoinOrderSide.Sell, Kucoin.Net.Objects.KucoinNewOrderType.Limit, price, quantity);
