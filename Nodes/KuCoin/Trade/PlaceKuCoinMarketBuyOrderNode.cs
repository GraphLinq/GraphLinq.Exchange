...
{
    [NodeDefinition("PlaceKuCoinMarketBuyOrderNode", "Place KuCoin Market Buy Order", NodeTypeEnum.Function, "KuCoin")]
    [NodeGraphDescription("Place KuCoin Market Buy Order")]
    public class PlaceKuCoinMarketBuyOrderNode : Node
    {
        public PlaceKuCoinMarketBuyOrderNode(string id, BlockGraph graph)
            : base(id, graph, typeof(PlaceKuCoinMarketBuyOrderNode).Name)
        {
        ...
        public override bool OnExecution()
        {
            ...
            var result = connector.Client.PlaceOrderAsync(symbol, Kucoin.Net.Objects.KucoinOrderSide.Buy, Kucoin.Net.Objects.KucoinNewOrderType.Market, null, quantity);
